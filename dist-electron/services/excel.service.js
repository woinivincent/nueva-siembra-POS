...
exports.generateSalesExcel = generateSalesExcel;
exports.generateCashRegisterExcel = generateCashRegisterExcel;
exports.generateReserveExcel = generateReserveExcel;
...
function applyTitleStyle(cell, color) {
...
async function generateSalesExcel(sales, startDate, endDate, businessName = 'NUEVA SIEMBRA') {
...
async function generateCashRegisterExcel(movements, summary, registerDate) {
    const { filePath, canceled } = await electron_1.dialog.showSaveDialog({
...
async function generateReserveExcel(movements, summary) {
    const { filePath, canceled } = await electron_1.dialog.showSaveDialog({
